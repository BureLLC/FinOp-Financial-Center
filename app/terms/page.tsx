      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "48px 40px 80px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "36px" }}>
          {[
            ...
            { num: "6", title: "Subscription and Payments", content: `Certain features require a paid subscription. By subscribing:\n\n• You authorize recurring charges to your payment method\n• Subscriptions renew automatically unless cancelled before renewal\n• Refunds are evaluated on a case-by-case basis\n• Pricing changes require 30 days advance notice\n\nTo cancel, contact contact@burellc.com. Access continues until the end of your paid period. For mobile subscriptions, billing is processed by Apple App Store or Google Play in-app purchases. Subscriptions auto-renew unless cancelled at least 24 hours before period end. Renewal is charged within 24 hours before period end. Manage/cancel and refunds through your Apple/Google account settings and policies; BURE LLC cannot directly cancel or refund store subscriptions.` },
        ...
        <div style={{ marginTop: "24px", textAlign: "center", fontSize: "12px", color: "#1e293b" }}>
          ...
          <span style={{ margin: "0 8px" }}>·</span>
          <a href="/disclosures" style={{ color: "#334155", textDecoration: "none" }}>Disclosures</a>
          <span style={{ margin: "0 8px" }}>·</span>
